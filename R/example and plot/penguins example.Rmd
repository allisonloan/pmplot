...
p1 <- add_brackets(base_b, specs1, label_offset = 0.04)
p1 + theme(
...
ggsave(filename = "../example and plot/p1.png", dpi = 300)
...
ggsave(filename = "../example and plot/p2.png", dpi = 300)
...
ggsave(filename = "../example and plot/p3.png", dpi = 300)
...
ggsave(filename = "../example and plot/p4.png", dpi = 300)
